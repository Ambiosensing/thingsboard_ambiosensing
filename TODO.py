...
# TODO 2 - Try the device-api-controller.replyToCommand and device-api-controller.subscribeToCommands services to implement a basic actuator interface (turn a relay/LED on/off through the service API interface, for example) - Need a prototype with
